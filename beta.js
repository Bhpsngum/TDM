...
var mapconfig = [
  ...
  },
  {
    ...
    map:
      ...
      "                                                  \n"+
      "                                                99\n"+
      "99              99999999999999999              999\n"+
      "999            9999999999999999999            9999\n"+
      "9999          999               999          99999\n"+
      "99999         99                 99         999999\n"+
      "999999        99                 99        9999999\n"+
      "9999999       99                 99       99999999\n"+
      "99999999      99                 99      999999999\n"+
      "999999999     99                 99     9999999999\n"+
      "999999999     99                999     9999999999\n"+
      "999999999     999              999      9999999999\n"+
      "999999999     9999            999       9999999999\n"+
      "99999999       9999          999         999999999\n"+
      "9999999         9999         99           99999999\n"+
      "999999           9999        9             9999999\n"+
      "99999             9999                      999999\n"+
      "9                  9999                          9\n"+
      "9                   9999                         9\n"+
      "9          99        9999            99          9\n"+
      ...
      "9                         9999                   9\n"+
      "99999                      9999             999999\n"+
      "999999             9        9999           9999999\n"+
      "9999999           99         9999         99999999\n"+
      "99999999         999          9999       999999999\n"+
      "999999999       999            9999     9999999999\n"+
      "999999999      999              999     9999999999\n"+
      "999999999     999                99     9999999999\n"+
      "999999999     99                 99     9999999999\n"+
      "99999999      99                 99      999999999\n"+
      "9999999       99                 99       99999999\n"+
      "999999        99                 99        9999999\n"+
  ...
  },
  {
    ...
    secondaries: [
      {x:Math.cos(Math.random()*Math.PI*2)*5,y:Math.sin(Math.random()*Math.PI*2)*5+5}
    ],
    spawn_delay: 20,
    restrict_tiers: false
  }
